...
<div class="home-banner">
	<div class="inner">
		<div class="container full">
			<a href="<?php echo LU('/');?>" class="logo fl animated" data-animate="fadeInDown"><img src="/public/assets/img/img_logo_white.png" /> </a>
			<div class="menu fr animated" data-animate="fadeInDown">
				<a href="javascript:" class="btn-lang-switcher">
					<svg viewBox="0 0 12 12" class="icon-lang"><path d="M3.48 3.5c.17-.85.43-1.6.75-2.18A5.02 5.02 0 001.67 3.5zm1.03 0h2.98C7.16 2 6.57 1 6 1S4.84 2 4.5 3.5zm4 0h1.82a5.02 5.02 0 00-2.56-2.18c.32.58.58 1.33.75 2.18zm.16 1a13.82 13.82 0 010 3h2.1a5 5 0 000-3zm-1.01 0H4.34a12.43 12.43 0 000 3h3.32a12.43 12.43 0 000-3zm-4.33 0h-2.1a5 5 0 000 3h2.1a13.82 13.82 0 010-3zm5.19 4a7.5 7.5 0 01-.75 2.18 5.02 5.02 0 002.56-2.18zm-1.03 0H4.51C4.84 10 5.43 11 6 11s1.16-1 1.5-2.5zm-4 0H1.66c.57 1 1.48 1.77 2.56 2.18a7.5 7.5 0 01-.75-2.18zM6 12A6 6 0 116 0a6 6 0 010 12z" fill="currentcolor"></path></svg>
					<span><?php echo ($data["current_lang_name"]); ?></span>
				</a>
		...
		<div class="container">
			<div class="feature">
				<h1 class="animated" data-animate="fadeInUp"><?php echo ($data["lang"]["SQUIRREAL"]); ?></h1>
				<h2 class="animated" data-animate="fadeInUp"><?php echo ($data["lang"]["PROGRAM_INTRO"]); ?></h2>
			</div>
...
<div class="section hot-country">
	<div class="container">
		<h2 class="section-title animated" data-animate="fadeInUp"><?php echo ($data["lang"]["HOT_COUNTRY"]); ?></h2>
				...
				<div class="swiper-container">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<a href="<?php echo LU('/country/'.$v['id']);?>" title="<?php echo ($v["full_name"]); ?>">
...
<div class="section hot-buildings">
	<div class="container">
		<h2 class="section-title animated" data-animate="fadeInUp"><?php echo ($data["lang"]["BEST_BUILDINGS"]); ?></h2>
		<div class="section-body animated" data-animate="fadeInUp">
            <?php foreach($data['hot_buildings'] as $k => $v):?>
			<a class="building-item" href="<?php echo LU('/building/'.$v['id']);?>" title="<?php echo ($v["name"]); ?>">
