<?php if (!defined('THINK_PATH')) exit(); if(IS_AJAX && IS_POST):?>
	...
	<div class="pagebar animated" data-animate="fadeInUp">
		<?php echo ($data["pager"]); ?>
	</div>
...
<div class="breadcrumb">
	<div class="container">
		...
		<img src="/public/assets/img/icon_arrow_right_s.png" />
		<span><a href="<?php echo LU('/city/'.$data['id']);?>"><?php echo ($data["info"]["name"]); ?></a></span>
		<img src="/public/assets/img/icon_arrow_right_s.png" />
		<span><?php echo ($data["lang"]["RELATED_BUILDINGS"]); ?></span>
	</div>
</div>

<?php if($data['buildings']):?>
<div class="section hot-buildings" style="background: #FFFFFF;min-height:600px">
	<div class="container">
		<h2 class="section-title animated" data-animate="fadeInUp"><?php echo ($data["lang"]["RELATED_BUILDINGS"]); ?></h2>
		<div class="section-body animated" data-animate="fadeInUp">
            <?php foreach($data['buildings'] as $k => $v):?>
