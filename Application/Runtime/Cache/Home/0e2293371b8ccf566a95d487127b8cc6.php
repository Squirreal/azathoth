...
<div class="country-banner">
	...
	<div class="country-image fl" style="background-image: url('<?=$data['banner_images'][1]['file']?>')"></div>

	<?php endif;?>

	<div class="country-image fl" style="background-image: url('<?=$data['banner_images'][0]['file']?>')">
		<div class="inner">
			<h2 class="country-name animated" data-animate="fadeInUp"><?php echo ($data["info"]["name"]); ?></h2>
			<div class="country-meta animated" data-animate="fadeInUp">
				<p><?php echo ($data["lang"]["POPULATION"]); ?>：<?php echo ($data["info"]["population"]); ?></p>
...
<div class="navbar" id="nav">
	<div class="container">
		<ul>
			<li data-target="hot-city"><?php echo ($data["lang"]["HOT_CITY"]); ?></li>
			<li data-target="country-identity"><?php echo ($data["lang"]["COUNTRY_IDENTITY"]); ?></li>
			<li data-target="country-immigration"><?php echo ($data["lang"]["IMMIGRATION"]); ?></li>
			<li data-target="country-feature"><?php echo ($data["lang"]["ECONOMIC_PROFILE"]); ?></li>
...
<?php if($data['hot_city']):?>
	<div class="section waypoint hot-city" id="hot-city">
		<div class="container">
			<h2 class="section-title animated" data-animate="fadeInUp"><?php echo ($data["lang"]["HOT_CITY"]); ?></h2>
						...
						<div class="swiper-wrapper">
                            <?php foreach ($data['hot_city'] as $k => $v):?>
								<div class="swiper-slide">
									<a href="<?php echo LU('/city/'.$v['id']);?>" title="<?php echo ($v["full_name"]); ?>">
										<div class="cover" style="background-image:url(<?php echo ($v["web_cover_img"]); ?>)"></div>
										<div class="inner">
											<h3><?php echo ($v["full_name"]); ?></h3>
										</div>
									</a>
								</div>
                            <?php endforeach;?>
...
<div class="section waypoint country-identity" id="country-identity">
	<div class="container">
		<h2 class="section-title animated" data-animate="fadeInUp"><?php echo ($data["lang"]["COUNTRY_IDENTITY"]); ?></h2>
		<div class="section-body animated" data-animate="fadeInUp">
			<?php echo ($data["info"]["feature"]); ?>
		</div>
	</div>
</div>

<div class="section waypoint country-immigration" id="country-immigration">
	<div class="container">
		<h2 class="section-title animated" data-animate="fadeInUp"><?php echo ($data["lang"]["IMMIGRATION"]); ?></h2>
		<div class="section-body animated" data-animate="fadeInUp">
			<?php echo ($data["info"]["immigration"]); ?>
		</div>
	</div>
</div>

<div class="section waypoint country-feature" id="country-feature">
	<div class="container">
		<h2 class="section-title animated" data-animate="fadeInUp"><?php echo ($data["lang"]["ECONOMIC_PROFILE"]); ?></h2>
		<div class="section-body animated" data-animate="fadeInUp">
			<div class="feature-item">
				<p class="icon"><img src="/public/assets/img/icon_monetization_on.png"/> </p>
				<p class="title">GDP</p>
				<p class="intro"><?php echo ($data["info"]["gdp"]); ?></p>
			</div>
			<div class="feature-item">
				<p class="icon"><img src="/public/assets/img/icon_attach_money.png"/> </p>
				<p class="title"><?php echo ($data["lang"]["GDP_PER_CAPITA"]); ?></p>
				<p class="intro"><?php echo ($data["info"]["gdp_per_capita"]); ?></p>
			</div>
			<div class="feature-item">
				<p class="icon"><img src="/public/assets/img/icon_trending_up.png"/> </p>
				<p class="title"><?php echo ($data["lang"]["GDP_GROWTH"]); ?></p>
				<p class="intro"><?php echo ($data["info"]["gdp_growth"]); ?></p>
			</div>
			<div class="feature-item">
				<p class="icon"><img src="/public/assets/img/icon_bookmarks.png"/> </p>
				<p class="title"><?php echo ($data["lang"]["RANKING_OF_SECURITY_COUNTRIES"]); ?></p>
				<p class="intro"><?php echo ($data["info"]["security_ranking"]); ?></p>
			</div>
		</div>
	</div>
</div>
