...
<div class="breadcrumb">
    <div class="container">
        ...
        <img src="/public/assets/img/icon_arrow_right_s.png" />
	    <span><a href="<?php echo LU('/city/buildings/id/'.$data['info']['city_id']);?>"><?php echo ($data["lang"]["RELATED_BUILDINGS"]); ?></a></span>
	    <img src="/public/assets/img/icon_arrow_right_s.png" />
...
<div class="navbar" id="nav">
    <div class="container">
        <ul>
            <li data-target="building-info"><?php echo ($data["lang"]["PROJECT_INFO"]); ?></li>
            <li data-target="purchase-process"><?php echo ($data["lang"]["PURCHASE_PROCESS"]); ?></li>
            <li data-target="loans"><?php echo ($data["lang"]["LOANS"]); ?></li>
        </ul>
    </div>
</div>
    ...
    <div class="container">
        <div class="building animated" data-animate="fadeInUp">
            ...
            <div class="building-info waypoint animated" data-animate="fadeInUp" id="building-info">
                <h3 class="info-title">
	                ...
	                <?php else:?>
	                <a href="javascript:" class="need-login"><?php echo ($data["lang"]["PROJECT_DOWNLOAD"]); ?><img src="/public/assets/img/icon_download.png" /> </a>
	                <?php endif;?>
	                <?php endif;?>
                </h3>
                <div class="info-body">
			                    ...
			                    <div class="swiper-wrapper">
				                    ...
				                    <div class="swiper-slide">
					                    <div class="apartment-item">
						                    ...
						                    <div>
							                    <p><?php echo ($data["lang"]["AREA"]); ?>：<?php echo ($v["area"]); echo ($data["lang"]["SP"]); ?></p>
							                    <p><?php echo ($data["lang"]["PRICE_ALIAS"]); ?>：<?php echo ($v["price"]); echo ($data["lang"]["SP"]); ?></p>
						                    </div>
					                    </div>
				                    </div>
            ...
            <div class="loans waypoint animated" data-animate="fadeInUp" id="loans">
                <h3 class="lo-title"><?php echo ($data["lang"]["LOANS"]); ?></h3>
                <div class="lo-body">
                    <?php echo ($data["info"]["loans"]); ?>
                </div>
            </div>
        </div>
        <div class="broker animated" data-animate="fadeInUp" id="broker">
	        <div class="broker-inner">
                ...
                <?php endif;?>
		        <button id="btn-consult" data-type="1" data-id="<?php echo ($data["id"]); ?>"><?php echo ($data["lang"]["CONSULT_NOW"]); ?></button>
	        </div>
